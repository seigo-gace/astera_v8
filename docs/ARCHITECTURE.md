...
## 6. KB-HB-016 decision

`KB-HB-016 / domain_lens_check_incomplete` is **not part of the canonical architecture**.
...
Do not preserve the same behavior under a new ID or renamed rule.
...
- `KB-HB-016` or an equivalent renamed replacement
